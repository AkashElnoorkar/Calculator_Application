...
def calci():
    class Calculator:
        ...
        def createButton(self,val,write=True,width=7):
            # This function creates a button and takes compulsory one argument, the value should be on the button.
        ...
        def click(self,text,write):
            # This function handles what happens when you click a button 'write' argument if True means the value 'val' should be written on screen, if None, should be written on the screen.
            if write==None:
        ...
        def clear_screen(self):
            # To clear screen, set equation to empty before deleting screen.
            self.equation=''
            self.screen.configure(state='normal')
